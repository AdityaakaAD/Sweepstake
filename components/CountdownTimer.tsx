...
function CountdownTimer() {
  ...
  const renderer = ({hours, minutes, seconds, completed}: Props)=>{
    if(completed){
      return(
      <div>
        <h2 className=' text-red-600 text-xl text-center animate-pulse'>Tickets sales have now Closed for this draw</h2>
      ...
      return(
      <div>
        <h3 className='text-emerald-700 mb-3 italic text-xl text-center'>Time Remaining</h3>
        <div className='flex space-x-6'>
          <div className='flex-1'>
